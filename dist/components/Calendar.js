...
var Calendar = function (_PureComponent) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderWeekdays() {
      ...
      var now = new Date();
      var weekDaysFormat = this.props.weekDaysFormat;
      ...
      return _react2.default.createElement(
        ...
        (0, _eachDayOfInterval2.default)({
          ...
          return _react2.default.createElement(
            ...
            (0, _format2.default)(day, weekDaysFormat ? weekDaysFormat : 'ddd', _this3.dateOptions)
          );
        })
      );
    }
    ...
    value: function render() {
      ...
      var _props7 = this.props,
          ...
          color = _props7.color,
          weekDaysFormat = _props7.weekDaysFormat;
